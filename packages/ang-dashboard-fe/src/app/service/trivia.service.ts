...
export class TriviaService {
  ...
  getTriviaById(id: string): Observable<Trivia> {
    return this.http.get<Trivia>(`${this.apiUrl}/${id}`, {
      headers: this.getAuthHeaders(),
    });
  }
  ...
  updateTrivia(
    id: string,
    trivia: Partial<CreateTriviaDto>
  ): Observable<Trivia> {
  ...
  activateTrivia(id: string): Observable<Trivia> {
    return this.http.post<Trivia>(
